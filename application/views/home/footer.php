...
<div class="row clearfix f-space30"></div>
  ...
  <footer class="footer">
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-xs-12 footermenu">
          ...
          <div class="social-icons">
            <ul>
              <li class="icon facebook"><a target="_blank" href="https://www.facebook.com/duongtuanvu"><i class="fa fa-facebook fa-fw"></i></a></li>
              <li class="icon google-plus"><a target="_blank" href="https://plus.google.com/+duongtuanvu"><i class="fa fa-google-plus fa-fw"></i></a></li>
              </br></br></br></br>
              <li class="icon twitter"><a target="_blank" href="https://twitter.com/duongtuanvu"><i class="fa fa-twitter fa-fw"></i></a></li>
              <li class="icon linkedin"><a target="_blank" href="http://www.linkedin.com/in/duongtuanvu"><i class="fa fa-linkedin fa-fw"></i></a></li>                            
            </ul>
          </div>
    ...
    <div class="copyrights">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 col-sm-8 col-xs-12"> <span class="copytxt">&copy; 2022 - <a href="<?=base_url()?>">FlatPC</a></span>   
        </div>
      </div>
    </div>
  </footer>
